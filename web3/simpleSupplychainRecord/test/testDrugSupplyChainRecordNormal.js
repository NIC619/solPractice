...
deployDrugSupplyChainRecord.deploy(web3, abiDrugSupplyChainRecord, bytecodeDrugSupplyChainRecord, authority).then(function(instance){
	...
	return funcDrugSupplyChainRecord.getDrugOwner(contractDrugSupplyChainRecord, authority, "Drug_C");
}).then(function(owner){
	console.log("Owner of drug name 'Drug_C':", owner);
	...
	console.log("Info of Drug_B's upstream Drug_A");
